package com.example.bmi_sarita;
...
public class MainActivity extends AppCompatActivity {
    private TextView tvWeight, txtResult, tvheight;
    ...
    private void initiate() {
        tvWeight = findViewById(R.id.txt_weight);
        tvheight = findViewById(R.id.txt_height);
    ...
    private void CalculateBMI() {
        ...
        float height = Float.parseFloat(tvheight.getText().toString()) / 100;
